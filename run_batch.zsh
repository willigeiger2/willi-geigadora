...
RESULTS_FILE="classification_results_$(date +%Y%m%d_%H%M%S).jsonl"
...
echo "=================================="
echo "Classification Batch Run"
echo "Started: $(date)"
echo "Model: @cf/llava-hf/llava-1.5-7b-hf"
...
echo "  New classifications: $total_upserted"
echo "  Skipped (already classified): $total_skipped"
